...
STOPWORDS = {
    ...
    "by", "at", "this", "that", "are", "be", "was", "were", "an"
}
...
class FileAnalyzer:
    ...
    def __init__(self, file_path: Path, show_progress: bool = False, encoding: str = 'utf-8',
                 top_words: int = 10, exclude_stopwords: bool = False):
